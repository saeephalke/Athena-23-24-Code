...
@Autonomous(name="Pushbot: Bottom Blue", group="Pushbot")
//@Disabled
public class BottomBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        strafe(DRIVE_SPEED, 10, -10, -10, 10, 10); //strafe to the left towards the hub ~2sq
        encoderDrive(DRIVE_SPEED,5, 5, 10); //go forward to drop freight ~0.5sq
